...
// import { Book, Star, RefreshCw, Settings, Save, X } from 'lucide-react';
...
//   useEffect(() => {
//     const savedAffirmation = localStorage.getItem('userAffirmation') || dayData.selfAffirmation || '';
//     setCurrentAffirmation(savedAffirmation);
//   }, [dayData.selfAffirmation]);
